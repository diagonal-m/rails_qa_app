...
| 質問一覧を表示（未解決）           | GET      | /questions           | questions#index         |
| 質問一覧を表示（解決済み）         | GET      | /questions           | questions#index         |
...
| 管理画面用のログインページを表示   | GET      | /admin/login         | admin/sessions#new      |
| (管理画面)質問一覧ページを表示     | GET      | /admin/questions     | admin/questions#index   |
